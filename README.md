...
> **Honest framing:** Nexus today is **multi-agent coordination** with real-time AI-to-AI negotiation — not yet a fully autonomous swarm. Agents act when invoked and negotiate when triggered. The autonomous-initiative layer (agents acting on a schedule, proactively) is on the roadmap, not shipped. This README is precise about what's working vs. what's coming.

---

## Why Nexus Is Different

Six things set Nexus apart from every other "AI Chief of Staff" in the market:
...
| 5 | **Live admin circuit board** | A real-time, n8n-style visualization of the entire system: agents, tools, data, events lighting up as they fire. |
| 6 | **Hybrid AI routing** | Each task is routed to the cheapest capable model (Claude Sonnet / Haiku, Gemini, or a free local model), cutting cost without cutting quality. |
...
- Connections page (link channels via UI, for managers *and* employees)
...
### 🔭 Coming Soon
- **Autonomous agent layer** — scheduled briefings, proactive deadline detection, agents initiating without being asked
...
```
 ...
 Phase 4   ◑   Omnichannel  (WhatsApp ✅ · Connections ✅ · Telegram 🟡 · Slack ✅)
 Phase 5   ○   Autonomous agent layer (proactive, scheduled)
 Phase 6   ○   Polish, onboarding, demo seeder
 Phase 7   ○   RAG / vector search
 Phase 8   ○   Compliance (SOC 2), scale hardening
```
...
*One AI per person. Agents that coordinate. Reachable everywhere.*
